...
@section('SideMenu')
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="{{ route('dashboard') }}" class="brand-logo">
                        {{-- <h2 class="text-light">{{ config('app.name') }}</h2> --}} <span> </span>
                        <img style="width:60px" alt="Logo" src="{{ asset('assets/media/logos/battle-rap-logo.png') }}" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item @if (request()->is('/')) menu-item-active @endif"
                                aria-haspopup="true">
                            ...
                            {{-- Admin --}}
                            <li class="menu-item @if (request()->is('admin*')) menu-item-active @endif"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item @if (request()->is('categories*')) menu-item-active @endif"
                                aria-haspopup="true">
                                <a href="{{ route('categories') }}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Compiling.svg--><svg
                            ...
                            <li class="menu-item @if (request()->is('videos*')) menu-item-active @endif"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item @if (request()->is('users*')) menu-item-active @endif"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item @if (request()->is('profile*')) menu-item-active @endif"
                                aria-haspopup="true">
    ...
    {{-- <li class="menu-section">
            <h4 class="menu-text">Admin Block</h4>
            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
        </li>
        <li class="menu-item menu-item-submenu @if (request()->is('admin*')) menu-item-active menu-item-open @endif"
