    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                ...
                <div class="card-body">
                    <!--begin::Form-->
                    <form method="post" class="form" action="{{ route('videoCreate') }}" id="kt_form"
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-3">
                                            <img id="frame" class="img-fluid" src="" alt="Preview" srcset="">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group date">
                                                <input type="text"
                                                    ...
                                                    id="kt_datepicker_2" readonly="readonly" name="releaseDate"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="form-group col-4">
                                            <input
                                                ...
                                                name="length" type="text" value="{{ old('length') }}" />
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-9">
                                            <textarea name="description" class="form-control form-control-solid" type="text">{{ old('videoName') }}</textarea>
                                            @if ($errors->has('videoName'))
                                                @error('videoName')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
