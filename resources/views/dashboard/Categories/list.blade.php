    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <a href="{{ route('categoryAdd') }}" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
                <!--end::Actions-->
            </div>
            <!--end::Info-->
        </div>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a href="{{ route('categoryAdd') }}" class="btn btn-primary font-weight-bolder">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-left">
                                                    ...
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        <li
                                                            ...
                                                            Choose an option:</li>
                                                        <li class="navi-item">
                                                            <a href="{{ route('categoryEdit', encrypt($category->id)) }}"
                                                                class="navi-link">
                                                        ...
                                                        <li class="navi-item">
                                                            <a onclick="remove('{{ encrypt($category->id) }}');"
                                                                {{-- href="{{ route('categoryDelete', encrypt($category->id)) }}" --}} class="navi-link">
                                                                <span class="navi-icon">
